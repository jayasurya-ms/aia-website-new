    ...
    return (
        <div className={cn("relative w-full text-foreground", className)}>
            ...
            <div className="border-t border-muted pt-8 relative flex items-center">
                ...
                <button
                    onClick={goPrev}
                    className="hidden xl:block absolute text-md -left-10 z-10 bg-[#F3831C] hover:bg-[#F3831C]/90 text-white p-2 rounded-full cursor-pointer"
                >
                    <ChevronLeft />
                </button>
                ...
                <div ref={thumbContainerRef} className="flex flex-nowrap overflow-x-auto overflow-y-hidden gap-4 md:gap-6 scroll-smooth no-scrollbar px-10 w-full p-2">
                    {reviews.map((review, idx) => (
                        <button
                            ...
                            className={cn(
                                "relative w-20 h-24 md:w-28 md:h-36 rounded-lg overflow-hidden transition-all duration-300 ring-2 ring-offset-2 focus:outline-none shrink-0",
                                currentIndex === idx
                ...
                <button
                    onClick={goNext}
                    className="hidden xl:block absolute text-md -right-10 z-10 bg-[#F3831C] hover:bg-[#F3831C]/90 text-white p-2 rounded-full cursor-pointer"
                >
                    <ChevronRight />
                </button>
            </div>
